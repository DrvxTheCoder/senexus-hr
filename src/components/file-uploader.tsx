    ...
    (acceptedFiles: File[], rejectedFiles: FileRejection[]) => {
      ...
      if (
        ...
        toast.promise(onUpload(updatedFiles), {
          ...
          success: () => {
            setFiles([]);
            return `${target.charAt(0).toUpperCase() + target.slice(1)} téléchargé${updatedFiles.length > 1 ? 's' : ''}`;
          },
                ...
                <div className='space-y-px'>
                  ...
                  <p className='text-muted-foreground/70 text-sm'>
                    ...
                    {maxFiles > 1
                      ...
                      fichiers (jusqu'à ${formatBytes(maxSize)} chacun)`
                      : ` un fichier avec ${formatBytes(maxSize)}`}
                  </p>
                </div>
              </div>
            )}
